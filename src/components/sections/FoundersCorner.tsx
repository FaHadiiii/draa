          ...
          >
            ...
            <div className="p-4 flex flex-col justify-between flex-1">
              <div>
                ...
                <h3 className="mt-3 text-sm font-semibold text-primary leading-snug group-hover:text-primary/90 transition-colors">
              ...
              <div className="mt-4 pt-3 border-t border-grey text-[10px] text-zinc-500 flex items-center gap-x-2">
                <span>Aug 10</span>
                <span>•</span>
